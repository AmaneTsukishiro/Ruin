...
#ifndef RUIN_UTILITY_NOT_EQUALS_HPP_INCLUDED
#define RUIN_UTILITY_NOT_EQUALS_HPP_INCLUDED
...
namespace ruin
{
	...
	static constexpr ruin::not_equals_t not_equals{};
}

#endif // RUIN_UTILITY_NOT_EQUALS_HPP_INCLUDED
