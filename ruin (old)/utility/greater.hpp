...
#ifndef RUIN_UTILITY_GREATER_HPP_INCLUDED
#define RUIN_UTILITY_GREATER_HPP_INCLUDED
...
namespace ruin
{
	...
	static constexpr ruin::greater_t greater{};
}

#endif // RUIN_UTILITY_GREATER_HPP_INCLUDED
